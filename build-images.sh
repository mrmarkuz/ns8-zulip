...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:18.6-alpine docker.io/memcached:1.6.45-alpine docker.io/rabbitmq:4.2.9 docker.io/redis:8.8.0-alpine ghcr.io/zulip/zulip-server:12.1-0" \
    "${container}"
# Commit the image
